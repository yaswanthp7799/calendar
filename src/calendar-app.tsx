            ...
            >
              ...
              {events.filter(event => isSameDay(event.date, day)).map((event, index) => (
                <div key={index} className="mt-1 text-sm">
                  {event.title}
                  <Button variant="ghost" size="sm" onClick={() => handleDeleteEvent(index)}>
          ...
          <DialogContent>
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Textarea id="description" value={newEventDescription} onChange={(e) => setNewEventDescription(e.target.value)} className="col-span-3" />
              </div>
            </div>
            <DialogFooter>
